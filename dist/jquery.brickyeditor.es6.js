        ...
        createContainer() {
            const onAdd = (block, idx) => {
                if (this.isLoaded) {
                    ...
                    this.trigger(BrickyEditor.Events.onChange, {
                        blocks: this.getData(),
                        html: this.getHtml()
                    });
                }
